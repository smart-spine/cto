...
- all code/config mutations must follow `CODE_AGENT_PROTOCOLS.md`.
...
- MICRO SCRATCH FASTPATH: for one-off ephemeral tasks with no project/config/apply/restart/deploy mutation, do NOT force intake survey/options; still execute via remembered code agent and return result evidence.
